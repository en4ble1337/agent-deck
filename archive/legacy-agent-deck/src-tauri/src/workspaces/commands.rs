...
use crate::terminal::close_workspace_terminal_sessions;
...
pub(crate) async fn remove_workspace(
    ...
    close_workspace_terminal_sessions(&state, &terminal_workspace_ids).await;
...
pub(crate) async fn remove_worktree(
    ...
    close_workspace_terminal_sessions(&state, std::slice::from_ref(&id)).await;
