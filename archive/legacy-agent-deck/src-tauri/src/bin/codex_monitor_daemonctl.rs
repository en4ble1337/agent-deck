...
const EXPECTED_DAEMON_NAME: &str = "agent-deck-daemon";
...
LISTEN 0      4096   0.0.0.0:4732      0.0.0.0:*    users:(("agent-deck-da",pid=12345,fd=7))
"#;
...
tcp        0      0 0.0.0.0:4732            0.0.0.0:*               LISTEN      6789/agent-deck-da
"#;
