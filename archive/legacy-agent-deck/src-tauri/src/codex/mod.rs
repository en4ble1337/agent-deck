...
#[tauri::command]
pub(crate) async fn codex_device_login(state: State<'_, AppState>) -> Result<Value, String> {
    crate::shared::codex_aux_core::codex_device_login_core(&state.app_settings).await
}
