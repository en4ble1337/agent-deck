...
describe("Messages", () => {
  ...
  it("routes markdown href file paths through the file opener", () => {
    const linkedPath =
      "/Users/dimillian/Documents/Dev/AgentDeck/src/features/messages/components/Markdown.tsx:244";
    const items: ConversationItem[] = [
      {
    ...
    expectOpenedFileTarget(
      openFileLinkMock,
      "/Users/dimillian/Documents/Dev/AgentDeck/src/features/messages/components/Markdown.tsx",
      244,
    );
  });
  ...
  it("routes absolute href file paths with #L anchors through the file opener", () => {
    const linkedPath =
      "/Users/dimillian/Documents/Dev/AgentDeck/src/features/messages/components/Markdown.tsx#L244";
    const items: ConversationItem[] = [
      {
  ...
  it("routes dotless workspace href file paths through the file opener", () => {
    const linkedPath = "/workspace/AgentDeck/LICENSE";
    const items: ConversationItem[] = [
      {
  ...
  it("renders absolute file references as workspace-relative paths", () => {
    const workspacePath = "/Users/dimillian/Documents/Dev/AgentDeck";
    const absolutePath =
      "/Users/dimillian/Documents/Dev/AgentDeck/src/features/messages/components/Markdown.tsx:244";
    const items: ConversationItem[] = [
      {
  ...
  it("renders hook rows through the standard tool renderer", () => {
    const items: ConversationItem[] = [
      {
        ...
        detail: "command â€¢ sync â€¢ thread â€¢ session-start.sh â€¢ Preparing",
        status: "failed",
    ...
    expect(screen.getByText("failed â€¢ 0:03")).toBeTruthy();

    fireEvent.click(screen.getByRole("button", { name: "Toggle tool details" }));
    expect(
      screen.getByText("command â€¢ sync â€¢ thread â€¢ session-start.sh â€¢ Preparing"),
    ).toBeTruthy();
