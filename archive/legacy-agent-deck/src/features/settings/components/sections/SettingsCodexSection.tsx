...
export function SettingsCodexSection({
  ...
  return (
    <SettingsSection
      title="Codex"
      subtitle="Configure the Codex CLI used by AgentDeck and validate the install."
    >
      ...
      <SettingsToggleRow
        ...
        subtitle={
          defaultModelsConnectedWorkspaceCount === 0
            ...
            : defaultModelsLoading
              ? "Loading models from the first workspaceâ€¦"
              : defaultModelsError
                ? `Couldnâ€™t load models: ${defaultModelsError}`
      ...
      <FileEditorCard
        ...
        placeholder="Add global instructions for Codex agentsâ€¦"
      ...
      <FileEditorCard
        ...
        placeholder="Edit the global Codex config.tomlâ€¦"
