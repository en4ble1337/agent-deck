...
describe("useAccountSwitching", () => {
  it("uses global device auth when there is no active workspace", async () => {
    vi.mocked(runCodexDeviceLogin).mockResolvedValue({
    ...
    expect(runCodexDeviceLogin).toHaveBeenCalled();
    expect(runCodexLogin).not.toHaveBeenCalled();
