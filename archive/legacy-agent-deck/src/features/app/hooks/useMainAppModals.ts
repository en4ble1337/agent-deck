...
function buildSettingsViewProps({
  ...
  return {
    ...
    accountSwitching: settings.accountSwitching,
    onSwitchCodexAccount: settings.onSwitchCodexAccount,
    onCancelCodexAccountSwitch: settings.onCancelCodexAccountSwitch,
  };
}
