...
type UseMainAppLayoutSurfacesArgs = {
  ...
  lastAgentMessageByThread: ThreadState["lastAgentMessageByThread"];
  ...
  onCycleTheme: SidebarProps["onCycleTheme"];
  ...
  onLoadHomeSessionOutput: LayoutNodesOptions["primary"]["homeProps"]["onLoadSessionOutput"];
  onSendHomeMessageToThread: LayoutNodesOptions["primary"]["homeProps"]["onSendMessageToThread"];
...
function buildPrimarySurface({
  ...
  onLoadHomeSessionOutput,
  onSendHomeMessageToThread,
  ...
  return {
    ...
    homeProps: {
      ...
      onLoadSessionOutput: onLoadHomeSessionOutput,
      onSendMessageToThread: onSendHomeMessageToThread,
      orchestratorToggleNode,
    },
