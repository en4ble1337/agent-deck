...
describe("Sidebar", () => {
  ...
  it("removes a workspace from the visible workspace action", () => {
    ...
    fireEvent.click(
      screen.getByRole("button", { name: "Remove Disposable Project workspace" }),
    );
  ...
  it("keeps account sign in available without an active workspace", () => {
    const onSwitchAccount = vi.fn();
    render(<Sidebar {...baseProps} onSwitchAccount={onSwitchAccount} />);
