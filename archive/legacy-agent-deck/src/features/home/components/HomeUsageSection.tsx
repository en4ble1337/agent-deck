  ...
  return (
    <div className="home-usage">
      <div className="home-section-header">
        <button
          type="button"
          className="home-usage-disclosure"
          onClick={() => setUsageExpanded((current) => !current)}
          aria-expanded={usageExpanded}
          aria-controls="home-usage-body"
          aria-label={usageExpanded ? "Hide usage snapshot" : "Show usage snapshot"}
        >
          <ChevronRight
            className={
              usageExpanded
                ? "home-usage-disclosure-icon is-expanded"
                : "home-usage-disclosure-icon"
            }
            aria-hidden
          />
          <span className="home-section-title">Usage snapshot</span>
        </button>
      ...
      {usageExpanded && (
        <div className="home-usage-body" id="home-usage-body">
