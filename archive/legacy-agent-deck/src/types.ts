...
export type OrchestratorFunctionCall = {
  name: string;
  arguments: string;
};
...
export type OrchestratorToolCall = {
  id: string;
  type: string;
  function: OrchestratorFunctionCall;
};
...
export type OrchestratorResponse = {
  message: OrchestratorMessage | null;
  toolCalls: OrchestratorToolCall[];
  finishReason: string | null;
  error: string | null;
};

export type OrchestratorTaskStatus = "queued" | "running" | "completed" | "failed";
