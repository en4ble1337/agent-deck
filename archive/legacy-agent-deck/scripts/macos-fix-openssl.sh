...
app_path="${1:-src-tauri/target/release/bundle/macos/Agent Deck.app}"
...
bin_path="${app_path}/Contents/MacOS/agent-deck"
daemon_path="${app_path}/Contents/MacOS/agent_deck_daemon"
daemonctl_path="${app_path}/Contents/MacOS/agent_deck_daemonctl"
daemon_source="${DAEMON_BINARY_PATH:-src-tauri/target/release/agent_deck_daemon}"
daemonctl_source="${DAEMONCTL_BINARY_PATH:-src-tauri/target/release/agent_deck_daemonctl}"
