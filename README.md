...
This command works from PowerShell, Git Bash, macOS, and Linux. On Windows it automatically uses the Windows Tauri config.

Optional Windows alias:

```powershell
npm run tauri:dev:win
```

If you want to run the backend check separately:
